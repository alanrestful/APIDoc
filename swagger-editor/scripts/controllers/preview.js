...
SwaggerEditor.controller('PreviewCtrl', function PreviewCtrl(Storage, Builder,
  ...
  */
   ...
   */
  function putServer(result) {
    // var data = result.specs;
    var preTime = window.localStorage.getItem('preTime');
    var now = new Date().getTime();
    if (!preTime) {
      // 立即更新
      console.log("updated");
      window.localStorage.setItem('preTime', now);
      return true;
    }
